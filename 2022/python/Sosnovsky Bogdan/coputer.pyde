...
def mouseClicked():
    ...
    if mouseX>=0 and mouseX<=300 and mouseY>=650 and mouseY<=750:
        ...
        textAlign(CENTER,CENTER)
        textSize(15)
        text("Coputer is disabled. Press the CROSS on the windows to shutdown your coputer",375,10)
def keyPressed():
    global sys,bios,sel,win10boot,win10logon,win10login,win7boot,win7logon,win7login
